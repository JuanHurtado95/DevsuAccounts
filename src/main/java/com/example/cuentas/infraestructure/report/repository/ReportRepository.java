package com.example.cuentas.infraestructure.report.repository;
...
public interface ReportRepository extends JpaRepository<AccountEntity, Long> {
    ...
    @Query("SELECT new com.example.cuentas.domain.report.dto.ReportDTO(a.numeroCuenta, a.saldo , a.tipoCuenta, m.fecha, m.tipoMovimiento, m.valor) " +
